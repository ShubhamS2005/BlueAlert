...
export const sendVerifymail = async (firstname, lastname, email, user_id) => {
    try {
      const subject = 'Blue Account Verification';
      ...
      const html = `
        <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f4f4f4;">
          <div style="max-width: 600px; margin: auto; background: #ffffff; padding: 30px; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
            ...
            <p style="font-size: 16px; color: #333;">Your account has been created on <strong>BlueAlert</strong>. Please verify your account by clicking the button below:</p>
